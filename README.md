...
```
The latest build version can be found [here](https://repos.appsfly.io/artifactory/libs-release-local). It is advised to upgrade periodically to the latest version.
